...
file_table.write(r'\caption{SVM}\label{tab:SVM}\centering' + "\n")
file_table.write(r'\begin{tabular}{?c|c|c?c|c?c|c?}' + "\n")
file_table.write(r'\noalign{\hrule height 1.5pt}'+ "\n")
file_table.write(r'\multirow{2}{*}{\textbf{Dim}} & \multirow{2}{*}{\textbf{Feat}} & \multirow{2}{*}{\textbf{Kernel}} & \multicolumn{2}{c?}{Training} & \multicolumn{2}{c?}{Test} \\' + "\n" )
file_table.write(r'\cline{4-7}' + "\n" )
file_table.write(r' &  & & \textbf{ROC} & \textbf{ROC PR} & \textbf{ROC} & \textbf{ROC PR} \\' + "\n" )
file_table.write(r'\noalign{\hrule height 1.5pt}'+ "\n")
   

DatasetBestThreshold_linear = {}
DatasetBestF2_linear = {}
DatasetBestThreshold_rbf = {}
DatasetBestF2_rbf = {}

DatasetBestThreshold_linearTrain = {}
DatasetBestF2_linearTrain = {}
DatasetBestThreshold_rbfTrain = {}
DatasetBestF2_rbfTrain = {}


for file_name in files:
    field =  file_name[:-4].split("_")
    OutputPath = "./" + field[4]  +  "/" + field[2] + "/" + field[3]
    ...
    if field[4] == "linear":
        if not field[2] in DatasetBestThreshold_linear.keys():
            DatasetBestThreshold_linear[field[2]] = {}
            DatasetBestF2_linear[field[2]] = {}
    else:
        if not field[2] in DatasetBestThreshold_rbf.keys():
            DatasetBestThreshold_rbf[field[2]] = {}
            DatasetBestF2_rbf[field[2]] = {}
            
    if field[4] == "linear":
        if not field[2] in DatasetBestThreshold_linearTrain.keys():
            DatasetBestThreshold_linearTrain[field[2]] = {}
            DatasetBestF2_linearTrain[field[2]] = {}
    else:
        if not field[2] in DatasetBestThreshold_rbfTrain.keys():
            DatasetBestThreshold_rbfTRain[field[2]] = {}
            DatasetBestF2_rbfTrain[field[2]] = {}
    BestTh = 0
    BestF2Score = 0
    ...
    if field[4] == "linear":            
        DatasetBestThreshold_linear[field[2]][field[3]] = BestTh   
        DatasetBestF2_linear[field[2]][field[3]] = BestF2Score 
    else:
        DatasetBestThreshold_rbf[field[2]][field[3]] = BestTh   
        DatasetBestF2_rbf[field[2]][field[3]] = BestF2Score 
        
        
    if field[4] == "linear":            
        DatasetBestThreshold_linearTrain[field[2]][field[3]] = BestTh   
        DatasetBestF2_linearTrain[field[2]][field[3]] = BestF2ScoreTrain 
    else:
        DatasetBestThreshold_rbfTrain[field[2]][field[3]] = BestThTRain   
        DatasetBestF2_rbfTrain[field[2]][field[3]] = BestF2ScoreTrain 
...
DataFramePandas.to_csv("SVM.csv")

DataFramePandas = pd.DataFrame.from_dict(DatasetBestThreshold_linear, orient='index')
DataFramePandas.to_csv("BestThresholdSVM_linear.csv")
DataFramePandas.to_excel("BestThresholdSVM_linear.xlsx")
DataFramePandas = pd.DataFrame.from_dict(DatasetBestF2_linear, orient='index')
DataFramePandas.to_csv("BestF2SVM_linear.csv")
DataFramePandas.to_excel("BestF2SVM_linear.xlsx")


DataFramePandas = pd.DataFrame.from_dict(DatasetBestThreshold_rbf, orient='index')
DataFramePandas.to_csv("BestThresholdSVM_rbf.csv")
DataFramePandas.to_excel("BestThresholdSVM_rbf.xlsx")
DataFramePandas = pd.DataFrame.from_dict(DatasetBestF2_rbf, orient='index')
DataFramePandas.to_csv("BestF2SVM_rbf.csv")
DataFramePandas.to_excel("BestF2SVM_rbf.xlsx")


DataFramePandas = pd.DataFrame.from_dict(DatasetBestThreshold_linearTrain, orient='index')
DataFramePandas.to_csv("BestThresholdSVM_linearTrain.csv")
DataFramePandas.to_excel("BestThresholdSVM_linearTrain.xlsx")
DataFramePandas = pd.DataFrame.from_dict(DatasetBestF2_linearTrain, orient='index')
DataFramePandas.to_csv("BestF2SVM_linearTrain.csv")
DataFramePandas.to_excel("BestF2SVM_linearTrain.xlsx")


DataFramePandas = pd.DataFrame.from_dict(DatasetBestThreshold_rbfTrain, orient='index')
DataFramePandas.to_csv("BestThresholdSVM_rbfTrain.csv")
DataFramePandas.to_excel("BestThresholdSVM_rbfTrain.xlsx")
DataFramePandas = pd.DataFrame.from_dict(DatasetBestF2_rbfTrain, orient='index')
DataFramePandas.to_csv("BestF2SVM_rbfTrain.csv")
DataFramePandas.to_excel("BestF2SVM_rbfTrain.xlsx")
