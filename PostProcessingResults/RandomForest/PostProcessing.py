...
file_table.write(r'\caption{RandomForest}\label{tab:RandomForest}\centering' + "\n")
...
DataFramePandas.to_csv("RandomForest.csv")

DataFramePandas = pd.DataFrame.from_dict(DatasetBestThreshold, orient='index')
DataFramePandas.to_csv("BestThresholdRandomForest.csv")
DataFramePandas.to_excel("BestThresholdRandomForest.xlsx")
DataFramePandas = pd.DataFrame.from_dict(DatasetBestF2, orient='index')
DataFramePandas.to_csv("BestF2RandomForest.csv")
DataFramePandas.to_excel("BestF2RandomForest.xlsx")


DataFramePandas = pd.DataFrame.from_dict(DatasetBestThresholdTrain, orient='index')
DataFramePandas.to_csv("BestThresholdRandomForestTrain.csv")
DataFramePandas.to_excel("BestThresholdRandomForestTrain.xlsx")
DataFramePandas = pd.DataFrame.from_dict(DatasetBestF2Train, orient='index')
DataFramePandas.to_csv("BestF2RandomForestTrain.csv")
DataFramePandas.to_excel("BestF2RandomForestTrain.xlsx")
