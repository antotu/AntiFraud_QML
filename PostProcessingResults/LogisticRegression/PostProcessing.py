...
file_table.write(r'\caption{LogisticRegression}\label{tab:LogistRegression}\centering' + "\n")
...
DataFramePandas.to_csv("LogisticRegression.csv")


DataFramePandas = pd.DataFrame.from_dict(DatasetBestThreshold, orient='index')
DataFramePandas.to_csv("BestThresholdLogisticRegression.csv")
DataFramePandas.to_excel("BestThresholdLogisticRegression.xlsx")
DataFramePandas = pd.DataFrame.from_dict(DatasetBestF2, orient='index')
DataFramePandas.to_csv("BestF2LogisticRegression.csv")
DataFramePandas.to_excel("BestF2LogisticRegression.xlsx")

DataFramePandas = pd.DataFrame.from_dict(DatasetBestThresholdTrain, orient='index')
DataFramePandas.to_csv("BestThresholdLogisticRegressionTrain.csv")
DataFramePandas.to_excel("BestThresholdLogisticRegressionTrain.xlsx")
DataFramePandas = pd.DataFrame.from_dict(DatasetBestF2Train, orient='index')
DataFramePandas.to_csv("BestF2LogisticRegressionTrain.csv")
DataFramePandas.to_excel("BestF2LogisticRegressionTrain.xlsx")
