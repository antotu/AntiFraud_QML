...
fileRes = open(f"Res_{numElements}_{numFeatures}_{precDigits}.txt", "w")

lsFile = os.listdir()
for file in lsFile:
    if file.endswith(".pth") and file.startswith(f"Strongly_{numElements}_{numFeatures}"):
        print(file)
