...
hyperparam = ["RandomForest", "RandomForestTrain"]
...
for h in hyperparam:
    with open('Elements_' + h + '.json', 'r') as file:
        ...
        for data in dataV:
            ...
            loaded_model = load(f'../../../ClassicMethods/RandomForestResult/RandomForest_{numEl}_{numF}.joblib')
...
with open(f"ResultsRandomForest.json", "w") as file:
