...
hyperparam = ["LogisticRegression", "LogisticRegressionTrain"]
...
for h in hyperparam:
    with open('Elements_' + h + '.json', 'r') as file:
        ...
        for data in dataV:
            ...
            loaded_model = load(f'../../../ClassicMethods/LogisticRegressionResult/LogisticRegression_{numEl}_{numF}.joblib')
...
with open(f"ResultsLogisticRegression.json", "w") as file:
