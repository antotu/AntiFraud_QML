...
with open("Elements_Train.json", "r") as file:
    ...
    for el in data:
        ...
        MODEL_SAVE_PATH = f"../../../ResultsFromHPC/Strongly/Features{NumFeatures}/"  + Ansatz + "_" + str(NumElements) + "_" + str(NumFeatures) + "_" + Encoding + "_"  + str(NumLayers) + "_" + str(Reuploading) + ".pth"
