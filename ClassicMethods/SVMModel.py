...
dump(model, f'./SVMResult/SVM_{numElements}_{numFeatures}_{kernel}.joblib')
...
pd.DataFrame({"threashold" : threas, 
    ...
    ).to_csv(f"./SVMResult/ResPrecisionRecall_SVM_{numElements}_{numFeatures}_{kernel}.csv")
